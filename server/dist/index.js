...
class ProofPayClient {
    ...
    constructor(rpcUrl, provider) {
        ...
        this.program = new Program(PROOFPAY_IDL, this.programId, provider);
    }
    async getEscrowPDA(escrowId) {
        const [pda] = PublicKey.findProgramAddressSync([Buffer.from("escrow"), Buffer.from(escrowId)], this.programId);
        return pda;
    }
